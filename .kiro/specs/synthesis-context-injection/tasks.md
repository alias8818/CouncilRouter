...
- [ ] 1. Update interfaces for query context injection
- [ ] 1.1 Update ISynthesisEngine interface to accept UserRequest parameter
...
- [ ] 1.2 Update IDevilsAdvocateModule interface with full implementation methods
...
- [ ] 1.3 Update ValidationResult interface with critical error flag
  - Add `isCriticalError: boolean` field
  - Update documentation to explain critical error handling
  - _Requirements: 2.1_

- [ ] 1.4 Write property test for interface consistency
  - **Property 1: Query Context Preservation Across All Strategies**
  - **Validates: Requirements 1.1, 1.2, 1.5, 4.2, 4.3**

- [ ] 2. Update SynthesisEngine core implementation
- [ ] 2.1 Update synthesize method signature and query extraction
...
- [ ] 2.2 Fix Consensus Extraction strategy for code responses
...
- [ ] 2.5 Write property test for code non-concatenation
  - **Property 2: Code Non-Concatenation**
  - **Validates: Requirements 2.1**

- [ ] 2.6 Write property test for query validation
  - **Property 8: Query Validation**
  - **Validates: Requirements 4.5**

- [ ] 3. Implement production-ready code synthesis prompts
- [ ] 3.1 Create specialized code synthesis prompt template
...
- [ ] 3.2 Update Meta-Synthesis to use code-specific prompts
...
- [ ] 3.3 Write property test for production-ready code prompt completeness
  - **Property 4: Production-Ready Code Prompt Completeness**
  - **Validates: Requirements 2.2, 2.3, 2.4, 2.5, 5.2, 5.3, 5.4, 5.5**

- [ ] 3.4 Write property test for code-specific prompt template selection
  - **Property 5: Code-Specific Prompt Template Selection**
  - **Validates: Requirements 5.1**

- [ ] 4. Enhance code validation with critical error detection
- [ ] 4.1 Update code validator to set critical error flag
...
- [ ] 4.2 Update synthesis strategies to respect critical error flag
  - Filter out responses with `isCriticalError: true` before synthesis
  - Log when responses are rejected due to critical errors
  - _Requirements: 2.1_

- [ ] 4.3 Write property test for critical error rejection
  - **Property 3: Critical Error Rejection**
  - **Validates: Requirements 2.1**

- [ ] 5. Implement Devil's Advocate critique generation
- [ ] 5.1 Implement critique method with LLM integration
...
- [ ] 5.2 Implement rewrite method with LLM integration
...
- [ ] 5.3 Implement synthesizeWithCritique orchestration method
...
- [ ] 5.4 Write property test for active critique generation
  - **Property 6: Active Critique Generation with LLM**
  - **Validates: Requirements 3.1, 3.2**

- [ ] 5.5 Write property test for critique-based rewrite
  - **Property 7: Critique-Based Rewrite with LLM**
  - **Validates: Requirements 3.3, 3.5**

- [ ] 6. Add Devil's Advocate configuration support
- [ ] 6.1 Define DevilsAdvocateConfig interface and add to ConfigurationManager
...
- [ ] 6.2 Update SynthesisEngine to conditionally invoke Devil's Advocate
...
- [ ] 6.3 Implement configuration hot-reload for Devil's Advocate
...
- [ ] 7.3 Add improvement indicator to synthesizeWithCritique logging
...
- [ ] 7.4 Write property test for Devil's Advocate logging completeness
  - **Property 10: Devil's Advocate Logging Completeness**
  - **Validates: Requirements 7.1, 7.2, 7.3, 7.4, 7.5**

- [ ] 8. Update OrchestrationEngine to pass UserRequest to SynthesisEngine
- [ ] 8.1 Update orchestration engine synthesis call
...
- [ ] 10. Add database schema for Devil's Advocate logging
- [ ] 10.1 Create devils_advocate_logs table
...
- [ ] 10.2 Update EventLogger to persist Devil's Advocate events
  - Add method to log Devil's Advocate events to database
  - Include all required fields from logging requirements
  - Handle database errors gracefully
  - _Requirements: 7.1, 7.2, 7.3, 7.4, 7.5_

- [ ] 11. Update existing tests for new interface signatures
- [ ] 11.1 Update SynthesisEngine unit tests
...
- [ ] 11.2 Update OrchestrationEngine integration tests
